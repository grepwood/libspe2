...
result=__c99_stdio_file_stdin_stderr_result.tmp
output_tmp=__c99_stdio_file_stdin_stderr_output.tmp

cat \
    data_c99_stdio_file_input.txt \
    data_c99_stdio_scanf_input.txt \
    data_c99_stdio_scanf_input.txt |
$loader spu_c99_stdio_file_stdin_stderr.spu.elf 2>$result || exit 1
